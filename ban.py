...
def authenticate():
    ...
    while True:
        ...
        print(banner_color + "📲 premo 🦞 Ban Tool")
...
def main_menu():
    ...
    while True:
        ...
        print(menu_color + "🛠️ premo Ban Tool")
...
def ban_unban_menu(action_type, report_type):
    ...
    # Get target number
    while True:
        phone = input(Fore.CYAN + "📞 𝗧𝗮𝗿𝗴𝗲𝘁 𝗻𝘂𝗺𝗯𝗲𝗿 (+𝟮55𝘅𝘅𝘅𝘅...): " + Fore.WHITE).strip()
